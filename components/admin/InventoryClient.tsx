        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex flex-wrap gap-2">
            <button
              ...
              className={`px-4 py-2 text-[10px] uppercase tracking-widest font-bold border transition-all flex items-center gap-2 ${activeTab === 'all'
            ...
            {CATEGORIES.map(cat => (
              <button
                ...
                className={`px-4 py-2 text-[10px] uppercase tracking-widest font-bold border transition-all ${activeTab === cat.slug
                  ? 'bg-bottle text-milky border-bottle shadow-md'
                  : 'bg-white text-bottle border-bottle/10 hover:border-bottle/30'
                  }`}
              >
