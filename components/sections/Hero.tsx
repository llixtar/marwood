    ...
    <section className="relative w-full overflow-hidden">
      ...
      <div className="grid grid-cols-1 md:grid-cols-[35%_25%_40%] h-auto md:min-h-[85vh]">
        ...
        <div className="relative h-[60vh] md:h-auto group overflow-hidden border-r border-bottle/5">
          ...
          <div className="absolute bottom-8 left-8 md:bottom-16 md:left-12 text-milky z-10">
            ...
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-light uppercase tracking-tighter mb-8 leading-[0.9] animate-in fade-in slide-in-from-bottom-4 duration-1000">
              Базова <br /> <span className="italic text-milky/80">естетика</span>
            </h2>
            <Button asChild variant="outline" className="bg-transparent border border-milky text-milky hover:bg-milky hover:text-bottle rounded-none px-8 py-6 text-xs md:text-sm uppercase tracking-widest transition-all duration-500 backdrop-blur-sm">
              <Link href="/category/basic">До колекції</Link>
            </Button>
          </div>
        </div>
        ...
        <div className="flex flex-col border-r border-bottle/5">
          ...
          {/* ВЕРХНЯ ФОТО */}
          <div className="relative h-[45vh] md:flex-1 group overflow-hidden border-b border-bottle/5">
            <Image
            ...
            <div className="absolute inset-0 bg-black/30 group-hover:bg-black/50 transition-colors duration-700 flex flex-col items-center justify-center text-center px-4">
              <h3 className="text-xl md:text-2xl text-milky uppercase tracking-[0.2em] font-extralight mb-4 translate-y-2 group-hover:translate-y-0 transition-transform duration-500">
                Lace & Desire
              </h3>
              <Button asChild variant="link" className="text-milky p-0 h-auto uppercase tracking-[0.3em] text-[10px] opacity-0 group-hover:opacity-100 transition-all duration-500 underline-offset-8">
                <Link href="/category/erotic">Дивитись все ➔</Link>
              </Button>
            </div>
          </div>

          {/* НИЖНЯ ФОТО */}
          <div className="relative h-[45vh] md:flex-1 group overflow-hidden bg-milky">
            <Image
            ...
            <div className="absolute top-6 left-6 md:top-8 md:left-8 text-bottle z-10">
              <h3 className="text-xl md:text-2xl uppercase font-light tracking-tight mb-2">Home & Sleep</h3>
              <p className="text-xs mb-4 opacity-80 max-w-[150px] leading-relaxed">
                Твій ідеальний ранок
              </p>
              <Link 
                href="/category/pajamas" 
                className="text-[10px] uppercase tracking-[0.4em] font-bold border-b border-bottle pb-1 hover:opacity-60 transition-opacity"
              >
                Обрати
              </Link>
            </div>
        ...
        <div className="relative h-[60vh] md:h-auto group overflow-hidden bg-bottle/5">
          <Image
          ...
          <div className="absolute bottom-8 left-8 md:bottom-16 md:left-12 text-milky z-10">
            ...
            <Button asChild variant="link" className="text-milky p-0 h-auto uppercase tracking-[0.3em] text-xs underline-offset-8 group-hover:text-milky/70 transition-colors">
              <Link href="/category/new">Детальніше ➔</Link>
            </Button>
          </div>
        </div>
