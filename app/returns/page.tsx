        ...
        <div className="space-y-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="space-y-4">
                ...
                <ul className="text-sm text-bottle/70 space-y-3">
                  <li>• Ви перевірили товар на пошті та зрозуміли, що розмір вам не підходить.</li>
                  <li>• Обмін здійснюється **тільки на аналогічну модель** іншого розміру.</li>
          ...
          <section className="bg-bottle text-milky p-8 md:p-12">
            ...
            <ol className="list-decimal list-inside space-y-6 text-sm opacity-90 leading-relaxed font-light">
              ...
              <li>Після перевірки товару нашими фахівцями, ми надішлемо вам інший розмір тієї ж моделі протягом 1-3 днів.</li>
            </ol>
          </section>
